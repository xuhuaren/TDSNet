...
class Dblock(nn.Module):
    def __init__(self,channel):
        ...
        self.dilate3 = nn.Conv2d(256, 256, kernel_size=3, dilation=4, padding=4)
        self.dilate4 = nn.Conv2d(256, 256, kernel_size=3, dilation=8, padding=8)
